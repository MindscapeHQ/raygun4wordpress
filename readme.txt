...
[Raygun.com](http://raygun.com) is an error reporting and tracking service that allows you to manage errors and exceptions received by websites and applications. It features an intuitive and powerful web interface which enables you to view error trends, receive updates and alerts through email and much more., where you can then view and manage them using the Raygun.io web application.

A 30-day free trial of Raygun.io is available.

This plugin allows you to send the PHP errors and exceptions generated by your Wordpress site to Raygun.com. It is quickly and easily configured using its Settings page available from your admin panel.

== Installation  ==

Simple add and enable this plugin, paste in your Raygun API Key (available when you create a new application in your Raygun.com dashboard) and you're done.
